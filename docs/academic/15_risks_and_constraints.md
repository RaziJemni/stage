...
| R-13 | Lack of direct customer interviews weakening study confidence | Medium | Medium | Validate workflows against documented domain requirements and automated testing; field interviews tracked as an open backlog issue (#34) for post-MVP pilots | Documentation coordinator |
