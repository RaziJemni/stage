...
| R-13 | Manque de validation empirique auprès des gestionnaires affaiblissant la portée des conclusions du mémoire | Élevée | Moyen | Élaboration d'un protocole d'entretien qualitatif standardisé (Chapitre 3 / Ticket #34) ; conduite d'enquêtes terrain et d'ateliers pilotes | Coordinateur documentation (*Documentation coordinator*) |
